...
using fixture = jst::test::left_ext_trimmed_merged_reverse::fixture;
using variant_t = jst::test::left_ext_trimmed_merged_reverse::variant_t;
struct left_ext_trimmed_merged_reverse_test : public jst::test::left_ext_trimmed_merged_reverse::test
{
    using typename jst::test::left_ext_trimmed_merged_reverse::test::rcs_store_t;
    using jst::test::left_ext_trimmed_merged_reverse::test::get_mock;
    using jst::test::left_ext_trimmed_merged_reverse::test::GetParam;
...
TEST_P(left_ext_trimmed_merged_reverse_test, root_sink) {
    auto tree = make_tree();
