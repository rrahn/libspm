...
using fixture = jst::test::seekable_sequence_tree_reverse::fixture;
using variant_t = jst::test::seekable_sequence_tree_reverse::variant_t;
struct seekable_sequence_tree_reverse_test : public jst::test::seekable_sequence_tree_reverse::test
{
    using typename jst::test::seekable_sequence_tree_reverse::test::rcs_store_t;
    using jst::test::seekable_sequence_tree_reverse::test::get_mock;
    using jst::test::seekable_sequence_tree_reverse::test::GetParam;
...
TEST_P(seekable_sequence_tree_reverse_test, seek) {
