...
struct trimmed_tree_test : public jst::test::labelled_tree::test
{
...
TEST_P(trimmed_tree_test, root_sink) {
    auto tree = make_tree();
...
INSTANTIATE_TEST_SUITE_P(no_variant, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{},
...
INSTANTIATE_TEST_SUITE_P(snv0, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{0}, .insertion{"C"s}, .deletion{1}, .coverage{0}}
    },
    .expected_labels{""s, "C"s, "AAA"s, "AAAAGGGG"s}
}));

INSTANTIATE_TEST_SUITE_P(snv7, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{7}, .insertion{"C"s}, .deletion{1}, .coverage{0}}
    },
    .expected_labels{"AAAAGGG"s, "C"s, ""s, "G"s}
}));

INSTANTIATE_TEST_SUITE_P(snv4, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{4}, .insertion{"C"s}, .deletion{1}, .coverage{0}}
    },
    .expected_labels{"AAAA"s, "C"s, "GGG"s, "GGGG"s}
}));

INSTANTIATE_TEST_SUITE_P(snv4_snv6, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{4}, .insertion{"C"s}, .deletion{1}, .coverage{0}},
    ...
    .expected_labels{"AAAA"s, "C"s, "G"s, "T"s, "G"s,
                                                      "GG"s,
                                  "GG"s, "T"s, "G"s,
                                             "GG"s}
}));

INSTANTIATE_TEST_SUITE_P(snv4_snv5, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{4}, .insertion{"C"s}, .deletion{1}, .coverage{0}},
    ...
    .expected_labels{"AAAA"s, "C"s, ""s, "T"s, "GG"s,
                                                      "GGG"s,
                                  "G"s, "T"s, "GG"s,
                                             "GGG"s}
}));

INSTANTIATE_TEST_SUITE_P(snv4_snv4, trimmed_tree_test, testing::Values(fixture{
    .source{"AAAAGGGG"s},
    .trim_size{3},
    .variants{
        variant_t{.position{4}, .insertion{"C"s}, .deletion{1}, .coverage{0}},
    ...
    .expected_labels{"AAAA"s, "C"s, "GGG"s,
                                  ""s, "T"s, "GGG"s,
                                  "GGGG"s}
}));
