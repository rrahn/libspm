...
{
    .event = {libjst::detail::test::position_t{.offset = 10u},
              libjst::detail::test::deletion_t{4},
              libjst::detail::test::coverage_t{0, 1, 1, 1, 0}},
    .expected_position{.offset = 14},
    .category = libjst::detail::test::event_category::join
}));

INSTANTIATE_TEST_SUITE_P(substitution_event, jst_event_test, testing::Values(jst_event_fixture
{
    .event = {libjst::detail::test::position_t{.offset = 10u},
              libjst::detail::test::substitution_t{"aaaa"s},
              libjst::detail::test::coverage_t{0, 1, 1, 1, 0}},
    .expected_position{.offset = 14},
    .category = libjst::detail::test::event_category::join
}));
...
{
    .event = {libjst::detail::test::position_t{.offset = 10u},
              libjst::detail::test::insertion_t{"aaaa"s},
              libjst::detail::test::coverage_t{0, 1, 1, 1, 0}},
    .expected_position{.offset = 10},
    .category = libjst::detail::test::event_category::join
}));
