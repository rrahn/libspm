...
inline constexpr auto chr22_needle32_ibf8192 = [] () {
    return benchmark_configuration{
        ...
        .jst_ibf_file{DATADIR"ALL.chr22.shapeit2_integrated_v1a.GRCh38.20181129.phased.vcf.jst.c8192.k21.ibf"}
    };
};

inline constexpr auto chr22_needle64_ibf8192 = [] () {
    return benchmark_configuration{
        .jst_file{DATADIR"ALL.chr22.shapeit2_integrated_v1a.GRCh38.20181129.phased.vcf.jst"},
...
inline constexpr auto chr22_needle128_ibf8192 = [] () {
    return benchmark_configuration{
        .jst_file{DATADIR"ALL.chr22.shapeit2_integrated_v1a.GRCh38.20181129.phased.vcf.jst"},
...
inline constexpr auto chr22_needle256_ibf8192 = [] () {
    return benchmark_configuration{
        .jst_file{DATADIR"ALL.chr22.shapeit2_integrated_v1a.GRCh38.20181129.phased.vcf.jst"},
...
inline constexpr auto chr22_sim100x100Ke3_ibf8192 = [] () {
    return benchmark_configuration{
        .jst_file{DATADIR"ALL.chr22.shapeit2_integrated_v1a.GRCh38.20181129.phased.vcf.jst"},
