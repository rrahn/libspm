...
BENCHMARK_TEMPLATE_DEFINE_F(fixture_oblivious_pattern, shiftor, capture<&chr22_needle256>)(benchmark::State& state) {
    run(state, libjst::shiftor_matcher(needle()));
}

BENCHMARK_REGISTER_F(fixture_oblivious_pattern, shiftor)
