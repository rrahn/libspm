...
namespace libjst
{
    ...
    class independent_branch_state : public branch_state_t
    {
    private:
    ...
    public:
        ...
        independent_branch_state() =  default;
        independent_branch_state(base_t && base, position_t context_size) :
        ...
        sequence_t sequence() const
        {
            ...
            position_t first_position = _head_position - std::min(_context_size, _head_position);
            it += first_position;
