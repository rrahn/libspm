...
public:
     ...
     * \{
     */
    using typename base_t::coverage_type; //!< The coverage type.
    using typename base_t::size_type; //!< The size type.
    using typename base_t::position_type; //!< The position type.
    //!\}
