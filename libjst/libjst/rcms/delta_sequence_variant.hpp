...
namespace libjst
{
    ...
    public:
        ...
        // {}
        explicit constexpr delta_sequence_variant(value_t const & snv) noexcept : _it{span_type{std::addressof(snv), 1}}
        {}
        constexpr delta_sequence_variant(source_t const & insertion) noexcept : _it{span_type{insertion}}
        {}
        ...
        constexpr iterator_impl begin() const noexcept {
            return _it;
        }

        constexpr sentinel_impl end() const noexcept {
            return sentinel_impl{};
        }
    };
