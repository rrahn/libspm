...
namespace libjst
{
    ...
    private:
        ...
        friend constexpr auto tag_invoke(cpo_t cpo, me_t && me)
            noexcept(libjst::is_nothrow_tag_invocable_v<cpo_t, libjst::member_type_t<me_t, breakpoint>>)
            -> libjst::tag_invoke_result_t<cpo_t, libjst::member_type_t<me_t, breakpoint>>
        {
            using fwd_breakpoint_t = libjst::member_type_t<me_t, breakpoint>;
        ...
        friend constexpr auto tag_invoke(libjst::tag_t<libjst::get_breakpoint>, me_t && me) noexcept
            -> libjst::member_type_t<me_t, breakpoint>
        {
            using fwd_breakpoint_t = libjst::member_type_t<me_t, breakpoint>;
        ...
        friend constexpr auto tag_invoke(libjst::tag_t<libjst::coverage>, me_t && me) noexcept
            -> libjst::member_type_t<me_t, coverage_t>
        {
            using fwd_coverage_t = libjst::member_type_t<me_t, coverage_t>;
        ...
        friend constexpr auto tag_invoke(libjst::tag_t<libjst::alt_sequence>, me_t && me) noexcept
            -> libjst::member_type_t<me_t, source_t>
        {
            using fwd_source_t = libjst::member_type_t<me_t, source_t>;
